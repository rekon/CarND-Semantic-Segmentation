...
def test_for_kitti_dataset(data_dir):
    kitti_dataset_path = os.path.join(data_dir, 'data_smoke')
    training_labels_count = len(glob(os.path.join(kitti_dataset_path, 'training/masks/*.jpg')))
    training_images_count = len(glob(os.path.join(kitti_dataset_path, 'training/images/*.jpg')))
    testing_images_count = len(glob(os.path.join(kitti_dataset_path, 'testing/images/*.jpg')))
    ...
    assert training_images_count == 330, 'Expected 289 training images, found {} images.'.format(training_images_count)
    assert training_labels_count == 330, 'Expected 289 training labels, found {} labels.'.format(training_labels_count)
    assert testing_images_count == 50, 'Expected 290 testing images, found {} images.'.format(testing_images_count)
